...
extern INV_FUNC(close);
extern INV_FUNC(dup2);
extern INV_FUNC(dup3);
extern INV_FUNC(epoll_wait);
extern INV_FUNC(fstat);
extern INV_FUNC(getcwd);
extern INV_FUNC(getdents);
extern INV_FUNC(getegid);
extern INV_FUNC(geteuid);
extern INV_FUNC(getgid);
extern INV_FUNC(getpid);
extern INV_FUNC(getppid);
extern INV_FUNC(getrlimit);
extern INV_FUNC(getrusage);
extern INV_FUNC(getsockname);
...
extern INV_FUNC(prlimit64);
extern INV_FUNC(pselect6);
extern INV_FUNC(read);
extern INV_FUNC(readlink);
extern INV_FUNC(recvfrom);
extern INV_FUNC(recvmsg);
extern INV_FUNC(select);
extern INV_FUNC(sendto);
extern INV_FUNC(socket);
extern INV_FUNC(stat);
extern INV_FUNC(statfs);
extern INV_FUNC(sysinfo);
