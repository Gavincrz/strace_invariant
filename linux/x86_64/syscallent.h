...
[ 51] = { 3,	TN,		SEN_TRACE(getsockname),		"getsockname"		},
...
[107] = { 0,	PU|NF,		SEN_TRACE(geteuid),			"geteuid"		},
[108] = { 0,	PU|NF,		SEN_TRACE(getegid),			"getegid"		},
...
[228] = { 2,	0,		SEN_TRACE(clock_gettime),		"clock_gettime"		},
