...
[ 21] = { 2,	TF,		SEN_TRACE(access),			"access"		},
[ 22] = { 1,	TD,		SEN(pipe),			"pipe"			},
[ 23] = { 5,	TD,		SEN_TRACE(select),			"select"		},
...
[ 39] = { 0,	PU|NF,		SEN_TRACE(getpid),			"getpid"		},
[ 40] = { 4,	TD|TN,		SEN(sendfile64),		"sendfile"		},
[ 41] = { 3,	TN,		SEN_TRACE(socket),			"socket"		},
...
[ 55] = { 5,	TN,		SEN_TRACE(getsockopt),		"getsockopt"		},
...
[ 78] = { 3,	TD,		SEN_TRACE(getdents),			"getdents"		},
[ 79] = { 2,	TF,		SEN_TRACE(getcwd),			"getcwd"		},
...
[102] = { 0,	PU|NF,		SEN_TRACE(getuid),			"getuid"		},
[103] = { 3,	0,		SEN(syslog),			"syslog"		},
[104] = { 0,	PU|NF,		SEN_TRACE(getgid),			"getgid"		},
...
[110] = { 0,	PU|NF,		SEN_TRACE(getppid),			"getppid"		},
...
[302] = { 4,	0,		SEN_TRACE(prlimit64),			"prlimit64"		},
