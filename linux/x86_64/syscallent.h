[  0] = { 3,	TD,		SEN_FUZZ(read), 			 "read"			},
[  1] = { 3,	TD,		SEN_FUZZ(write),			 "write"			},
[  2] = { 3,	TD|TF,		SEN_FUZZ(open),			"open"			},
...
[ 17] = { 4,	TD,		SEN_FUZZ(pread),			"pread64"		},
[ 18] = { 4,	TD,		SEN(pwrite),			"pwrite64"		},
[ 19] = { 3,	TD,		SEN(readv),			"readv"			},
[ 20] = { 3,	TD,		SEN_FUZZ(writev),			"writev"		},
[ 21] = { 2,	TF,		SEN_FUZZ(access),			"access"		},
[ 22] = { 1,	TD,		SEN_FUZZ(pipe),			"pipe"			},
[ 23] = { 5,	TD,		SEN_FUZZ(select),			"select"		},
...
[ 32] = { 1,	TD,		SEN_FUZZ(dup),			"dup"			},
[ 33] = { 2,	TD,		SEN_FUZZ(dup2),			"dup2"			},
[ 34] = { 0,	TS,		SEN(pause),			"pause"			},
[ 35] = { 2,	0,		SEN_FUZZ(nanosleep),			"nanosleep"		},
[ 36] = { 2,	0,		SEN(getitimer),			"getitimer"		},
[ 37] = { 1,	0,		SEN(alarm),			"alarm"			},
[ 38] = { 3,	0,		SEN_FUZZ(setitimer),			"setitimer"		},
...
[ 44] = { 6,	TN,		SEN_FUZZ(sendto),			"sendto"		},
[ 45] = { 6,	TN,		SEN_FUZZ(recvfrom),			"recvfrom"		},
[ 46] = { 3,	TN,		SEN_FUZZ(sendmsg),			"sendmsg"		},
[ 47] = { 3,	TN,		SEN_FUZZ(recvmsg),			"recvmsg"		},
[ 48] = { 2,	TN,		SEN(shutdown),			"shutdown"		},
[ 49] = { 3,	TN,		SEN_FUZZ(bind),			"bind"			},
[ 50] = { 2,	TN,		SEN_FUZZ(listen),			"listen"		},
[ 51] = { 3,	TN,		SEN_FUZZ(getsockname),		"getsockname"		},
[ 52] = { 3,	TN,		SEN_FUZZ(getpeername),		"getpeername"		},
[ 53] = { 4,	TN,		SEN_FUZZ(socketpair),		"socketpair"		},
[ 54] = { 5,	TN,		SEN_FUZZ(setsockopt),		"setsockopt"		},
[ 55] = { 5,	TN,		SEN_FUZZ(getsockopt),		"getsockopt"		},
...
[ 61] = { 4,	TP,		SEN_FUZZ(wait4),			"wait4"			},
[ 62] = { 2,	TS,		SEN(kill),			"kill"			},
[ 63] = { 1,	0,		SEN_FUZZ(uname),			"uname"			},
...
[ 78] = { 3,	TD,		SEN_FUZZ(getdents),			"getdents"		},
[ 79] = { 2,	TF,		SEN_FUZZ(getcwd),			"getcwd"		},
[ 80] = { 1,	TF,		SEN_FUZZ(chdir),			"chdir"			},
[ 81] = { 1,	TD,		SEN(fchdir),			"fchdir"		},
[ 82] = { 2,	TF,		SEN_FUZZ(rename),			"rename"		},
[ 83] = { 2,	TF,		SEN_FUZZ(mkdir),			"mkdir"			},
[ 84] = { 1,	TF,		SEN(rmdir),			"rmdir"			},
[ 85] = { 2,	TD|TF,		SEN(creat),			"creat"			},
[ 86] = { 2,	TF,		SEN_FUZZ(link),			"link"			},
[ 87] = { 1,	TF,		SEN_FUZZ(unlink),			"unlink"		},
[ 88] = { 2,	TF,		SEN_FUZZ(symlink),			"symlink"		},
[ 89] = { 3,	TF,		SEN_FUZZ(readlink),			"readlink"		},
[ 90] = { 2,	TF,		SEN_FUZZ(chmod),			"chmod"			},
...
[ 97] = { 2,	0,		SEN_TRACE(getrlimit),			"getrlimit"		},
[ 98] = { 2,	0,		SEN_TRACE(getrusage),			"getrusage"		},
[ 99] = { 1,	0,		SEN_FUZZ(sysinfo),			"sysinfo"		},
...
[106] = { 1,	0,		SEN_FUZZ(setgid),			"setgid"		},
[107] = { 0,	PU|NF,		SEN_FUZZ(geteuid),			"geteuid"		},
[108] = { 0,	PU|NF,		SEN_FUZZ(getegid),			"getegid"		},
[109] = { 2,	0,		SEN(setpgid),			"setpgid"		},
[110] = { 0,	PU|NF,		SEN_FUZZ(getppid),			"getppid"		},
[111] = { 0,	PU|NF,		SEN_FUZZ(getpgrp),			"getpgrp"		},
[112] = { 0,	0,		SEN_FUZZ(setsid),			"setsid"		},
[113] = { 2,	0,		SEN(setreuid),			"setreuid"		},
[114] = { 2,	0,		SEN(setregid),			"setregid"		},
[115] = { 2,	0,		SEN_FUZZ(getgroups),			"getgroups"		},
[116] = { 2,	0,		SEN_FUZZ(setgroups),			"setgroups"		},
[117] = { 3,	0,		SEN_FUZZ(setresuid),			"setresuid"		},
[118] = { 3,	0,		SEN(getresuid),			"getresuid"		},
[119] = { 3,	0,		SEN_FUZZ(setresgid),			"setresgid"		},
...
[137] = { 2,	TF|TSF|TSFA,	SEN_FUZZ(statfs),			"statfs"		},
...
[161] = { 1,	TF,		SEN_FUZZ(chroot),			"chroot"		},
...
[228] = { 2,	0,		SEN_FUZZ(clock_gettime),		"clock_gettime"		},
...
[233] = { 4,	TD,		SEN_FUZZ(epoll_ctl),			"epoll_ctl"		},
...
[257] = { 4,	TD|TF,		SEN_FUZZ(openat),			"openat"		},
...
[262] = { 4,	TD|TF|TFST|TSTA,SEN_TRACE(newfstatat),		"newfstatat"		},
...
[270] = { 6,	TD,		SEN_TRACE(pselect6),			"pselect6"		},
...
[288] = { 4,	TN,		SEN_FUZZ(accept4),			"accept4"		},
[289] = { 4,	TD|TS,		SEN(signalfd4),			"signalfd4"		},
[290] = { 2,	TD,		SEN(eventfd2),			"eventfd2"		},
[291] = { 1,	TD,		SEN_FUZZ(epoll_create1),		"epoll_create1"		},
[292] = { 3,	TD,		SEN_FUZZ(dup3),			"dup3"			},
[293] = { 2,	TD,		SEN_FUZZ(pipe2),			"pipe2"			},
